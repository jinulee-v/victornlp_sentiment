...
def main():
  ...
  if args.finetune_model_dir and args.config_file == 'victornlp_sentiment/config.json':
  ...
  loss_fn = sentiment_loss_fn[train_config['loss_fn']]
  ...
  accuracy = sentiment_analysis_fn['accuracy']
